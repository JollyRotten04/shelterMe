...
<header class="fixed inset-x-0 top-0 z-50 sm: h-2" style="background-color: white; height: 4rem;">
  ...
  <div class="fixed sm: h-10" id="secondRowContainer" style="left: 0; width: 100%; padding: 0.5rem 2rem 0.5rem 2rem; box-sizing: border-box; display: flex; justify-content: space-between; background-color: white; z-index: 100;">
   ...
   <div class="flex" id="thirdContainer" style="width:100%; margin-top: 4rem; justify-content: flex-end;">
        <div id="sortByContainer">
            
        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" style="background-color: black;" class="text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center" type="button">
            Sort By 
            <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6" style="background-color: black;">
      ...
      <div class="mx-auto" style= "height: 100%; display: flex; flex-direction: column; padding-top: 1rem; padding-bottom: 7rem; box-sizing: border-box;">

        <!-- First Content Stack -->
        <div id="mainContainer" style="height: 100%; width: 100%;">
            
            <div id="gridContainer" class="grid grid-cols-4 gap-2 md:!gap-2 lg:!gap-4 !pb-40">
                <img src="{{ asset('assets/suburban house 1.png') }}" class="" alt="" style=""/>
                <img src="{{ asset('assets/suburban house 1.png') }}" class="" alt="" style=""/>
                <img src="{{ asset('assets/suburban house 1.png') }}" class="" alt="" style=""/>
                <img src="{{ asset('assets/suburban house 1.png') }}" class="" alt="" style=""/>
